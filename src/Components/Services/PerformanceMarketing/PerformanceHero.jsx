        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 lg:gap-20 mb-12">
            ...
            <div className="flex-1">
              ...
              >
                Paid advertising should do more than put your brand in front of people.
              </p>
            </div>
            ...
            <div className="flex-1">
              ...
              >
                ADSSERV builds performance marketing campaigns around the audience, offer, creative, landing experience, budget, and conversion goal — then uses campaign data to understand what is working and what needs to change.
                <br /><br />
                From Google Ads and paid social to ongoing optimisation, we focus on making every part of the journey more accountable.
              </p>
