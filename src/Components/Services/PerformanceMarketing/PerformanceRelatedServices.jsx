...
const relatedServices = [
  { title: "SEO Services", desc: "Improve organic visibility alongside your paid campaign activity.", cta: "Explore SEO Services", href: "/services/seo", icon: Search, img: imgSEO },
  { title: "Social Media Marketing", desc: "Build brand awareness and audience relationships across social platforms.", cta: "Explore Social Media Marketing", href: "/services/social-media-marketing", icon: Users, img: imgPerf },
  { title: "Website Development", desc: "Give your paid traffic a clear, well-structured, conversion-focused destination.", cta: "Explore Website Development", href: "/services/website-development", icon: Monitor, img: imgWeb },
  { title: "Video Production", desc: "Create stronger creative assets for your paid advertising campaigns.", cta: "Explore Video Production", href: "/services/video-production", icon: Video, img: imgVideo },
  { title: "Content Writing", desc: "Strengthen the ad copy, landing page copy, and offer messaging within your campaigns.", cta: "Explore Content Writing", href: "/services/content-writing", icon: PenTool, img: imgInfluencer },
  { title: "Branding", desc: "Create the brand assets that make your advertising feel more credible and distinctive.", cta: "Explore Branding", href: "/services/branding", icon: Megaphone, img: imgContent }
];

export default function PerformanceRelatedServices() {
    ...
    <section ref={sectionRef} className="w-full py-24 relative font-primary" style={{ backgroundColor: 'var(--bg-light-purple)' }}>
      <div className="max-w-[1300px] w-full mx-auto px-4 md:px-8 relative z-10">
        ...
        <div ref={headingRef} className="flex flex-col items-center text-center mb-16">
          ...
          <ScrollRevealHeading
            words={[
              { text: "Paid" }, { text: "marketing" }, { text: "works" }, { text: "better" },
              { text: "when" }, { text: "the" }, { text: "rest" }, { text: "of" },
              { text: "the", italic: true }, { text: "system" }, { text: "supports" }, { text: "it." }
            ]}
          />
        </div>
