...
import img1 from '../../../assets/Services/Influncer Marketing.webp';
import img2 from '../../../assets/SocailMedia/Connect.webp';
import img3 from '../../../assets/SocailMedia/Entertain.webp';
import img4 from '../../../assets/SocailMedia/Build Trust.webp';
...
import img8 from '../../../assets/Services_Provide/Social media marketing.webp';

const services = [
  { num: "01", title: "Influencer Strategy", desc: "Define the role creators should play within the wider marketing campaign.", img: img1 },
  { num: "02", title: "Creator Discovery", desc: "Find creators whose audience, content, platform, location, and niche align with the campaign.", img: img2 },
  { num: "03", title: "Influencer Shortlisting", desc: "Build a focused creator shortlist based on campaign requirements rather than vanity metrics alone.", img: img3 },
  { num: "04", title: "Campaign Management", desc: "Coordinate communication, deliverables, timelines, approvals, publishing, and campaign requirements.", img: img4 },
  { num: "05", title: "Content Collaboration", desc: "Develop creative direction that gives creators enough guidance to protect the brand without making the content feel scripted.", img: img5 },
  { num: "06", title: "Product & Brand Collaborations", desc: "Create creator partnerships around launches, products, services, campaigns, events, and brand awareness.", img: img6 },
  { num: "07", title: "UGC Campaigns", desc: "Develop creator-led user-generated content that brands can use across organic and paid marketing where appropriate.", img: img7 },
  { num: "08", title: "Performance & Reporting", desc: "Review available campaign data such as reach, views, engagement, clicks, traffic, content performance, and agreed campaign outcomes.", img: img8 },
];
      ...
      <div className="max-w-[1200px] w-full mx-auto px-4 md:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          <div className="flex-1 text-center lg:text-left relative z-10">
            ...
            <p
              className="text-[16px] md:text-[18px] leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0 font-medium"
              style={{ color: 'var(--brand-navy)', opacity: 0.85 }}
            >
              From strategy and discovery to campaign management and reporting — we handle the full
              creator campaign process so collaborations feel intentional, not improvised.
            </p>
            ...
            >
              ...
              <div className="absolute top-0 inset-x-0 flex justify-between items-center px-6 pt-4 pb-2 text-[12px] font-semibold text-[var(--brand-navy)] z-50 pointer-events-none">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <svg width="14" height="10" viewBox="0 0 14 10" fill="currentColor"><path d="M7 9C6.44772 9 6 8.55228 6 8C6 7.44772 6.44772 7 7 7C7.55228 7 8 7.44772 8 8C8 8.55228 7.55228 9 7 9Z"/></svg>
