...
import { Share2, Megaphone, Video, Palette, Monitor, ArrowRight } from 'lucide-react';
...
const relatedServices = [
  ...
  { title: "Performance Marketing", desc: "Extend suitable creator content into paid campaigns where usage rights allow.", cta: "Explore Performance Marketing", href: "/services/performance-marketing", icon: Megaphone, img: imgPerf },
  { title: "Video Production", desc: "Create polished brand-led video when the campaign needs production beyond creator content.", cta: "Explore Video Production", href: "/services/video-production", icon: Video, img: imgVideo },
        ...
        <div ref={headingRef} className="flex flex-col items-center text-center mb-16">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="italic font-semibold uppercase tracking-widest" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '13px', color: 'var(--accent-orange)' }}>
              CREATOR CAMPAIGNS DON'T HAVE TO WORK ALONE
            </span>
          </div>
          <ScrollRevealHeading
            words={[
