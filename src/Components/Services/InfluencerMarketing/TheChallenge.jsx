...
const considerations = [
  "Who the creator speaks to",
  "What their audience responds to",
  "How they communicate",
  "Which platforms they actually understand",
  "Whether their content style makes sense for the brand"
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          <div ref={leftRef} className="lg:col-span-5 flex flex-col justify-start">
            <div className="flex items-center gap-2 mb-6">
              ...
              >
                THE CREATOR ISN'T THE STRATEGY
              </span>
            </div>
            <ScrollRevealHeading
              words={[
          ...
          <div ref={rightTextRef} className="lg:col-span-7 flex flex-col gap-6 text-[16px] md:text-[18px] font-medium leading-relaxed text-slate-700">
            <p>Follower count is easy to see. Audience relevance isn't.</p>
            <p>
              A creator can have a huge audience and still be completely wrong for your brand, product,
              location, category, or campaign objective.
            </p>
            ...
            <div ref={cardRef} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mt-2">
              <p className="text-[15px] font-semibold mb-4" style={{ color: 'var(--brand-navy)' }}>
                We consider:
              </p>
            ...
            <p ref={finalRef} className="mt-4 font-bold" style={{ color: 'var(--brand-navy)' }}>
              The goal is not simply to get a creator to post. The goal is to make the collaboration make sense.
            </p>
          </div>
        </div>
      </div>
