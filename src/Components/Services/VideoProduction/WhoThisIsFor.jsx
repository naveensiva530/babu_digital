...
const audiences = [
  { title: 'Startups', desc: "Introduce the idea, product, people, or problem you're solving without making the brand feel bigger or smaller than it really is.", image: 'https://images.unsplash.com/photo-1559136555-e4616d9d15e2?auto=format&fit=crop&q=80&w=800' },
  { title: 'Growing Businesses', desc: 'Turn products, services, expertise, and customer stories into content that can travel across digital channels.', image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=800' },
  { title: 'SaaS & Technology', desc: 'Make complex products easier to understand through demonstrations, explainers, product stories, and educational content.', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800' },
  { title: 'Consumer Brands', desc: 'Create visual content that gives products a stronger presence across social, campaigns, websites, and launches.', image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=800' },
  { title: 'Local Businesses', desc: 'Show the people, place, experience, and personality behind the business.', image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&q=80&w=800' },
];
      ...
      <div className="max-w-[1200px] w-full mx-auto px-4 md:px-8 relative z-10" ref={containerRef}>
        <div className="flex flex-col items-center text-center mb-20 md:mb-28">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="italic font-semibold uppercase tracking-widest" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '13px', color: 'var(--accent-orange)' }}>VIDEO FOR</span>
          </div>
          <ScrollRevealHeading maxW="900px" words={[
            { text: 'For' }, { text: 'brands' }, { text: 'that' }, { text: 'have', italic: true },
            { text: 'something' }, { text: 'worth' }, { text: 'showing.' }
          ]} />
        </div>
        ...
        <div className="relative w-full">
          ...
          <div className="flex flex-col relative z-10">
            {audiences.map((item, index) => (<StepRow key={index} step={item} index={index} />))}
          </div>
        </div>
      </div>
    </section>
