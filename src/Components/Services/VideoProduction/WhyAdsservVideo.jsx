...
export default function WhyAdsservVideo() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div ref={leftRef} className="flex flex-col">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="italic font-semibold uppercase tracking-widest" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '13px', color: 'var(--accent-orange)' }}>OUR CREATIVE APPROACH</span>
            </div>
          ...
          <div className="flex flex-col gap-4 text-[16px] md:text-[18px] font-medium leading-relaxed text-slate-700">
            ...
            <p ref={el => paraRefs.current[3] = el} className="font-bold" style={{ color: 'var(--brand-navy)' }}>
              That keeps the production creative without losing sight of why the content exists in the first place.
            </p>
          </div>
        </div>
      </div>
