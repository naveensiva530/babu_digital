    ...
    <>
      <div className="relative w-full flex items-center justify-center overflow-hidden" style={{ height: '420px', marginTop: '90px' }}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
          <h1 className="font-extrabold text-white mb-5 tracking-tight leading-tight" style={{ fontSize: 'clamp(2.2rem, 5vw, 3.6rem)', textShadow: '0 4px 24px rgba(80,0,180,0.25)' }}>Digital Consulting</h1>
          <div className="flex items-center gap-3 px-6 py-3 rounded-full mt-1" style={{ background: '#ffffff', boxShadow: '0 4px 20px rgba(80,0,180,0.12)' }}>
            ...
            <span className="text-[16px] font-semibold" style={{ color: '#1e2f57' }}>Digital Consulting</span>
          </div>
        </div>
      ...
      <section className="w-full bg-white pt-16 pb-20 px-4 md:px-8" style={{ fontFamily: "'Inter', sans-serif" }}>
        <div className="max-w-[1200px] mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="italic font-semibold uppercase tracking-widest" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '13px', color: 'var(--accent-orange, #e08326)' }}>DIGITAL CONSULTING</span>
          </div>

          <ScrollRevealHeading className="mb-10" words={[
            { text: "Stop" }, { text: "Guessing." }, { text: "Know" }, { text: "What" },
            { text: "Your", italic: true }, { text: "Digital" }, { text: "Strategy" },
            { text: "Should" }, { text: "Do" }, { text: "Next." }
          ]} />
          ...
          <div className="flex flex-col md:flex-row gap-8 lg:gap-20 mb-12">
            <div className="flex-1">
              <p className="leading-relaxed font-medium" style={{ fontSize: 'clamp(1rem, 2vw, 1.25rem)', color: '#334155' }}>
                Your business doesn't need more random digital activity. It needs a clearer direction.
              </p>
            </div>
            <div className="flex-1">
              <p className="leading-relaxed mb-10" style={{ fontSize: 'clamp(0.95rem, 1.6vw, 1.1rem)', color: '#475569' }}>
                ADSSERV helps you identify what's working, what's getting in the way, where the real opportunities are, and what to prioritise next.
              </p>
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <ButtonWithIcon>Talk to a Digital Strategist</ButtonWithIcon>
                <a href="#how-we-work">
