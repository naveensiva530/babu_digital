      ...
      <div className="relative w-full flex items-center justify-center overflow-hidden" style={{ height: '420px', marginTop: '90px' }}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
          ...
          <div className="flex items-center gap-3 px-6 py-3 rounded-full mt-1" style={{ background: '#ffffff', boxShadow: '0 4px 20px rgba(80,0,180,0.12)' }}>
            ...
            <span className="text-[16px] font-semibold" style={{ color: '#1e2f57' }}>SEO Services</span>
          </div>
        </div>
      ...
      <section className="w-full bg-white pt-16 pb-20 px-4 md:px-8" style={{ fontFamily: "'Inter', sans-serif" }}>
        <div className="max-w-[1200px] mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="italic font-semibold uppercase tracking-widest" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '13px', color: 'var(--accent-orange, #e08326)' }}>SEO Services</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 lg:gap-20 mb-12">
            <div className="flex-1">
              <p className="leading-relaxed font-medium" style={{ fontSize: 'clamp(1rem, 2vw, 1.25rem)', color: '#334155' }}>
                Getting traffic is not the whole point. The real goal is to become visible when someone is actively searching for what your business offers — and then give them a reason to choose you.
              </p>
            </div>
            <div className="flex-1">
              <p className="leading-relaxed mb-4" style={{ fontSize: 'clamp(0.95rem, 1.6vw, 1.1rem)', color: '#475569' }}>
                ADSSERV builds SEO strategies around technical foundations, search intent, content, authority, local visibility, and continuous improvement.
              </p>
              <p className="leading-relaxed mb-4" style={{ fontSize: 'clamp(0.95rem, 1.6vw, 1.1rem)', color: '#475569' }}>
                No shortcuts. No keyword stuffing. No promises of overnight rankings.
              </p>
              <p className="leading-relaxed mb-10" style={{ fontSize: 'clamp(0.95rem, 1.6vw, 1.1rem)', color: '#475569' }}>
                Just search strategy built around how people actually discover businesses.
              </p>
