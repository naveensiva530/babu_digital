...
import { Monitor, PenTool, Share2, Megaphone, Palette, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-[1300px] w-full mx-auto px-4 md:px-8 relative z-10">
        <div ref={headingRef} className="flex flex-col items-center text-center mb-16">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="italic font-semibold uppercase tracking-widest" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '13px', color: 'var(--accent-orange)' }}>SEO WORKS BETTER AS PART OF THE SYSTEM</span>
          </div>
