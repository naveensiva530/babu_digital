        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          <div ref={leftRef} className="lg:col-span-5 flex flex-col justify-start">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="italic font-semibold uppercase tracking-widest" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '13px', color: 'var(--accent-orange)' }}>SEO IS MORE THAN KEYWORDS</span>
            </div>
            <ScrollRevealHeading words={[
              { text: "Ranking" }, { text: "for" }, { text: "the" }, { text: "wrong" },
              { text: "searches", italic: true }, { text: "won't" }, { text: "grow" },
              { text: "the" }, { text: "right" }, { text: "business." }
            ]} />
          </div>
          ...
          <div ref={rightTextRef} className="lg:col-span-7 flex flex-col gap-6 text-[16px] md:text-[18px] font-medium leading-relaxed text-slate-700">
            <p>A website can have hundreds of keywords and still attract very little meaningful business.</p>
            <p className="font-bold" style={{ color: 'var(--brand-navy)' }}>Why? Because visibility without intent is often just noise.</p>
            <p>Effective SEO connects what people search for with what your business actually sells.</p>
            ...
            <p ref={finalRef} className="mt-4 font-bold" style={{ color: 'var(--brand-navy)' }}>That's where the real work begins.</p>
          </div>
        </div>
      </div>
    </section>
