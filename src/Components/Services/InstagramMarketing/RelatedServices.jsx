...
import { Share2, Megaphone, Video, PenLine, Palette, Search, ArrowRight } from 'lucide-react';
...
const relatedServices = [
  ...
  { title: 'Video Production', desc: 'Create Reels and short-form video content that captures attention.', cta: 'Explore Video Production', href: '/services/video-production', icon: Video, img: imgVideo },
  { title: 'Content Writing', desc: 'Give your Instagram captions and copy a clear, consistent voice.', cta: 'Explore Content Writing', href: '/services/content-writing', icon: PenLine, img: imgContent },
      ...
      <div className="max-w-[1300px] w-full mx-auto px-4 md:px-8 relative z-10">
        <div ref={headingRef} className="flex flex-col items-center text-center mb-16">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="italic font-semibold uppercase tracking-widest" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '13px', color: 'var(--accent-orange)' }}>MORE THAN INSTAGRAM</span>
          </div>
          <ScrollRevealHeading maxW="800px" words={[
            { text: "Instagram" }, { text: "works" }, { text: "better" }, { text: "when" },
            { text: "the", italic: true }, { text: "rest" }, { text: "of" }, { text: "your" }, { text: "digital" }, { text: "presence" }, { text: "is" }, { text: "ready" }, { text: "too." }
          ]} />
        </div>
