      ...
      <div className="max-w-[1200px] w-full mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div ref={rightTextRef} className="lg:col-span-7 flex flex-col gap-6 text-[16px] md:text-[18px] font-medium leading-relaxed text-slate-700">
            <p>A busy social feed can still produce very little.</p>
            <p>Random posts, recycled trends, inconsistent visuals, unclear messaging, and content without a purpose can make a brand look active without making it memorable.</p>
            ...
            <p ref={finalRef} className="mt-4 font-bold" style={{ color: 'var(--brand-navy)' }}>
              We build the social strategy around those questions.
            </p>
          </div>
