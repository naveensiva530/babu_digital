...
const services = [
  {
    ...
    desc: "A clear direction for what you should post and who you're speaking to.",
    img: img1
  },
  {
    num: "02",
    title: "Content Strategy",
    desc: "Content pillars, themes, and messaging designed around your audience.",
    img: img2
  },
  {
    num: "03",
    title: "Social Media Management",
    desc: "Consistent planning, publishing, and monitoring of your channels.",
    img: img3
  },
  {
    num: "04",
    title: "Social Media Content",
    desc: "Platform-aware posts, captions, creative concepts, and assets.",
    img: img4
  },
  {
    num: "05",
    title: "Reels & Short-Form",
    desc: "Short-form video concepts designed around how people consume content.",
    img: img5
  },
  {
    num: "06",
    title: "Community Management",
    desc: "Thoughtful interaction with your audience through conversations.",
    img: img6
  },
  {
    num: "07",
    title: "Social Campaigns",
    desc: "Campaign concepts designed around specific launches or goals.",
    img: img7
  },
  {
    num: "08",
    title: "Social Media Analytics",
    desc: "Performance analysis that identifies what is creating engagement.",
    img: img8
  }
];
      ...
      <div className="max-w-[1200px] w-full mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left relative z-10">
            ...
            >
              We build comprehensive strategies and deliver end-to-end execution. From defining your core messaging to creating scroll-stopping content, we handle every aspect of your social media presence.
            </p>
