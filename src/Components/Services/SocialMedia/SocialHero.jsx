        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 lg:gap-20 mb-12">
            ...
            <div className="flex-1">
              ...
              >
                Your audience is already scrolling. The challenge is earning a few seconds of their attention —
                and giving them a reason to remember your brand.
              </p>
            </div>
            ...
            <div className="flex-1">
              ...
              >
                ADSSERV builds social media marketing strategies around your audience, platform behaviour,
                content, creative direction, community, and business goals. From the first idea to ongoing
                optimisation, we turn social media into a more intentional part of your digital marketing.
              </p>
...
const iconPillStyle = {
  ...
  boxShadow: '0 8px 32px rgba(80,0,180,0.18)',
